...
private router : Router) { 
  ...
  updateRekAddressDialog() : void{
    let dialogRef = this.dialog.open(UpdateRekAddressDialog2, {
      width: '400px',
    });
...
export class UpdateRekAddressDialog2 implements OnInit {

  constructor(
   
    public dialogRef: MatDialogRef<UpdateRekAddressDialog2>,
    @Inject(MAT_DIALOG_DATA) public data: any,
  private router : Router) { }
